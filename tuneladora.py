...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=
	colored("Some examples:\n\n#1")+colored(" tuneladora 8080 user@192.168.1.5", "green")+colored(" Redirects local port 8080 to remote port 8080 on remote machine 192.168.1.5")+colored("\n\n#2")+colored(" tuneladora '8080->80' user@192.168.1.5", "green")+colored(" Redirects local port 8080 to remote port 80 on remote machine 192.168.1.5")+colored("\n\n#3")+colored(" tuneladora '8080->80+8081->81' user@192.168.1.5", "green")+colored(" Redirects local port 8080 to remote port 80 and local port 8081 to remote port 81 on remote machine 192.168.1.5")+colored("\n\n#4")+colored(" tuneladora '8080:8085' user@192.168.1.5", "green")+colored(" Same as '8080->8080+8081->8081+8082->8082+8083->8083+8084->8084+8085->8085' 192.168.1.5")+colored("\n\n#5")+colored(" tuneladora '172.26.0.15#localhost#8080' user@192.168.1.5", "green")+colored(" Redirects local port 8080 of (local interface) 172.26.0.15 to remote port 8080 on remote machine 192.168.1.5")+colored("\n\n#6")+colored(" tuneladora '172.26.0.15#localhost#8080,9090+192.168.1.5#9000->9100+10000:10005' user@192.168.1.5", "green")+colored(" Redirects [local ports 8080 and 9090 of (local interface) 172.26.0.15 to remote ports 8080 and 9090 AND redirects local port 9000 to remote port 9100 of (remote interface) 192.168.1.5 AND redirects local ports 10000 to 10005 to remote ports 10000 to 10005] ON remote machine 192.168.1.5"))
