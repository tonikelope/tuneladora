...
parser.add_argument("ports", help="[[local_address#]<remote_address#>]<lport[->rport]|lport_init:lport_end[,...]>[+...]")

parser.add_argument("destination", help="Destination host.")

parser.add_argument('--proxy', help="ssh -o ProxyCommand='THIS-CONTENT'")
